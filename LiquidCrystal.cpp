/*
 * LiquidCrystal.cpp - LiquidCrystal Library for STM32 ARM microcontrollers
 *
 *  Created on: April 12, 2018
 *      Original C Author: S. Saeed Hosseini (sayidhosseini@hotmail.com), ported to C++ by Coiland
...
void LiquidCrystal::init(uint8_t fourbitmode, GPIO_TypeDef *gpioport, uint16_t rs, uint16_t rw, uint16_t enable,
			 uint16_t d0, uint16_t d1, uint16_t d2, uint16_t d3,
...
void LiquidCrystal::enableClock(void)
{  
  if(_port == GPIOA)
